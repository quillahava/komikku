...
def tuttoanimemanga_server():
    from komikku.servers.tuttoanimemanga import Tuttoanimemanga
...
def test_tuttoanimemanga(tuttoanimemanga_server):
    ...
    try:
        response = tuttoanimemanga_server.get_latest_updates()
    ...
    try:
        ...
        response = tuttoanimemanga_server.search(response[0]['name'])
    ...
    try:
        response = tuttoanimemanga_server.get_manga_chapter_data(slug, None, None, chapter_url)
